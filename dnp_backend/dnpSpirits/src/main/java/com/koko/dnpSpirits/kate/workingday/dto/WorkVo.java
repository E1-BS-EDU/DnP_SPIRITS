package com.koko.dnpSpirits.kate.workingday.dto;

public class WorkVo {
	private int workNo;
	private int gubunCd;
	private String gubunA;
	private String gubunB;
	...
	public void setGubunA(String gubunA) {
		this.gubunA = gubunA;
	}
	public String getGubunB() {
		return gubunB;
	}
	public void setGubunB(String gubunB) {
		this.gubunB = gubunB;
	}
	public String getGubunDesc() {
		return gubunDesc;
	}
	public void setGubunDesc(String gubunDesc) {
		this.gubunDesc = gubunDesc;
	}
